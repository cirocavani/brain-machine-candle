...
impl Decoder {
    ...
    fn new(
        ...
        // https://github.com/openblob/e8622f9afc4eba139bf796c210f5c01081000472/whisper/decoding.py#L452
    ...
    fn decode(&mut self, mel: &Tensor, t: f64) -> Result<DecodingResult> {
        ...
        for i in 0..sample_len {
            ...
            // https://github.com/openblob/e8622f9afc4eba139bf796c210f5c01081000472/whisper/decoding.py#L439
...
pub fn main() -> Result<()> {
    ...
    let device = whisper_mic::device(args.cpu)?;
